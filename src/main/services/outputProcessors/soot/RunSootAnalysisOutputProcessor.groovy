...
class RunSootAnalysisOutputProcessor implements OutputProcessor {
    ...
    RunSootAnalysisOutputProcessor(String dependenciesPath) {
        ...
        this.detectionAlgorithms = [
                ...
                new ConflictDetectionAlgorithm("Confluence Intra", "dfp-confluence-intraprocedural-pa", this.sootWrapper, TIMEOUT),
                new ConflictDetectionAlgorithm("Confluence Inter", "dfp-confluence-interprocedural-pa", this.sootWrapper, TIMEOUT),
                ...
                new NonCommutativeConflictDetectionAlgorithm("DFP-Intra-pa", "dfp-intra", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("DFP-Inter-pa", "dfp-inter", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("CD-pa", "cd-pa", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("CDe-pa", "cd-e-pa", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("PDG-pa", "pdg-pa", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("PDG-e-pa", "pdg-e-pa", this.sootWrapper, TIMEOUT),
