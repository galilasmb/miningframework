...
class RunSootAnalysisOutputProcessor implements OutputProcessor {
    ...
    RunSootAnalysisOutputProcessor(String dependenciesPath) {
        ...
        this.detectionAlgorithms = [
                ...
                new NonCommutativeConflictDetectionAlgorithm("CD", "cd-pa", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("CDe", "cd-e-pa", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("PDG", "pdg-pa", this.sootWrapper, TIMEOUT),
                new NonCommutativeConflictDetectionAlgorithm("PDG-e", "pdg-e-pa", this.sootWrapper, TIMEOUT),
