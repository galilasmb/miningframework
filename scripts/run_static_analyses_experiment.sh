...
do
    ...
    ./gradlew run -DmainClass="services.outputProcessors.soot.Main" --args="-dfp-confluence-interprocedural-pa -dfp-inter-pa -ioa-with-pa -pdg-pa -report -t 1800 -spark true"
